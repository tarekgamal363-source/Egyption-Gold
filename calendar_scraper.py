...
def get_calendar(min_impact="Low", countries=("USD",)):
    ...
    for e in raw_events:
        ...
        actual = _parse_number(e.get("actual"))
        trend = None
